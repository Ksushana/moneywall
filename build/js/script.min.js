 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */t.widget("ui.tooltip",{version:"1.12.1",options:{classes:{"ui-tooltip":"ui-corner-all ui-widget-shadow"},content:function(){var e=t(this).attr("title")||"";return t("<a>").text(e).html()},hide:!0,items:"[title]:not([disabled])",position:{my:"left top+15",at:"left bottom",collision:"flipfit flip"},show:!0,track:!1,close:null,open:null},_addDescribedBy:function(e,i){var s=(e.attr("aria-describedby")||"").split(/\s+/);s.push(i),e.data("ui-tooltip-id",i).attr("aria-describedby",t.trim(s.join(" ")))},_removeDescribedBy:function(e){var i=e.data("ui-tooltip-id"),s=(e.attr("aria-describedby")||"").split(/\s+/),n=t.inArray(i,s);-1!==n&&s.splice(n,1),e.removeData("ui-tooltip-id"),(s=t.trim(s.join(" ")))?e.attr("aria-describedby",s):e.removeAttr("aria-describedby")},_create:function(){this._on({mouseover:"open",focusin:"open"}),this.tooltips={},this.parents={},this.liveRegion=t("<div>").attr({role:"log","aria-live":"assertive","aria-relevant":"additions"}).appendTo(this.document[0].body),this._addClass(this.liveRegion,null,"ui-helper-hidden-accessible"),this.disabledTitles=t([])},_setOption:function(e,i){var s=this;this._super(e,i),"content"===e&&t.each(this.tooltips,(function(t,e){s._updateContent(e.element)}))},_setOptionDisabled:function(t){this[t?"_disable":"_enable"]()},_disable:function(){var e=this;t.each(this.tooltips,(function(i,s){var n=t.Event("blur");n.target=n.currentTarget=s.element[0],e.close(n,!0)})),this.disabledTitles=this.disabledTitles.add(this.element.find(this.options.items).addBack().filter((function(){var e=t(this);if(e.is("[title]"))return e.data("ui-tooltip-title",e.attr("title")).removeAttr("title")})))},_enable:function(){this.disabledTitles.each((function(){var e=t(this);e.data("ui-tooltip-title")&&e.attr("title",e.data("ui-tooltip-title"))})),this.disabledTitles=t([])},open:function(e){var i=this,s=t(e?e.target:this.element).closest(this.options.items);s.length&&!s.data("ui-tooltip-id")&&(s.attr("title")&&s.data("ui-tooltip-title",s.attr("title")),s.data("ui-tooltip-open",!0),e&&"mouseover"===e.type&&s.parents().each((function(){var e,s=t(this);s.data("ui-tooltip-open")&&((e=t.Event("blur")).target=e.currentTarget=this,i.close(e,!0)),s.attr("title")&&(s.uniqueId(),i.parents[this.id]={element:this,title:s.attr("title")},s.attr("title",""))})),this._registerCloseHandlers(e,s),this._updateContent(s,e))},_updateContent:function(t,e){var i,s=this.options.content,n=this,o=e?e.type:null;if("string"==typeof s||s.nodeType||s.jquery)return this._open(e,t,s);(i=s.call(t[0],(function(i){n._delay((function(){t.data("ui-tooltip-open")&&(e&&(e.type=o),this._open(e,t,i))}))})))&&this._open(e,t,i)},_open:function(e,i,s){var n,o,a,r,l=t.extend({},this.options.position);function h(t){l.of=t,o.is(":hidden")||o.position(l)}s&&((n=this._find(i))?n.tooltip.find(".ui-tooltip-content").html(s):(i.is("[title]")&&(e&&"mouseover"===e.type?i.attr("title",""):i.removeAttr("title")),n=this._tooltip(i),o=n.tooltip,this._addDescribedBy(i,o.attr("id")),o.find(".ui-tooltip-content").html(s),this.liveRegion.children().hide(),(r=t("<div>").html(o.find(".ui-tooltip-content").html())).removeAttr("name").find("[name]").removeAttr("name"),r.removeAttr("id").find("[id]").removeAttr("id"),r.appendTo(this.liveRegion),this.options.track&&e&&/^mouse/.test(e.type)?(this._on(this.document,{mousemove:h}),h(e)):o.position(t.extend({of:i},this.options.position)),o.hide(),this._show(o,this.options.show),this.options.track&&this.options.show&&this.options.show.delay&&(a=this.delayedShow=setInterval((function(){o.is(":visible")&&(h(l.of),clearInterval(a))}),t.fx.interval)),this._trigger("open",e,{tooltip:o})))},_registerCloseHandlers:function(e,i){var s={keyup:function(e){if(e.keyCode===t.ui.keyCode.ESCAPE){var s=t.Event(e);s.currentTarget=i[0],this.close(s,!0)}}};i[0]!==this.element[0]&&(s.remove=function(){this._removeTooltip(this._find(i).tooltip)}),e&&"mouseover"!==e.type||(s.mouseleave="close"),e&&"focusin"!==e.type||(s.focusout="close"),this._on(!0,i,s)},close:function(e){var i,s=this,n=t(e?e.currentTarget:this.element),o=this._find(n);o?(i=o.tooltip,o.closing||(clearInterval(this.delayedShow),n.data("ui-tooltip-title")&&!n.attr("title")&&n.attr("title",n.data("ui-tooltip-title")),this._removeDescribedBy(n),o.hiding=!0,i.stop(!0),this._hide(i,this.options.hide,(function(){s._removeTooltip(t(this))})),n.removeData("ui-tooltip-open"),this._off(n,"mouseleave focusout keyup"),n[0]!==this.element[0]&&this._off(n,"remove"),this._off(this.document,"mousemove"),e&&"mouseleave"===e.type&&t.each(this.parents,(function(e,i){t(i.element).attr("title",i.title),delete s.parents[e]})),o.closing=!0,this._trigger("close",e,{tooltip:i}),o.hiding||(o.closing=!1))):n.removeData("ui-tooltip-open")},_tooltip:function(e){var i=t("<div>").attr("role","tooltip"),s=t("<div>").appendTo(i),n=i.uniqueId().attr("id");return this._addClass(s,"ui-tooltip-content"),this._addClass(i,"ui-tooltip","ui-widget ui-widget-content"),i.appendTo(this._appendTo(e)),this.tooltips[n]={element:e,tooltip:i}},_find:function(t){var e=t.data("ui-tooltip-id");return e?this.tooltips[e]:null},_removeTooltip:function(t){t.remove(),delete this.tooltips[t.attr("id")]},_appendTo:function(t){var e=t.closest(".ui-front, dialog");return e.length||(e=this.document[0].body),e},_destroy:function(){var e=this;t.each(this.tooltips,(function(i,s){var n=t.Event("blur"),o=s.element;n.target=n.currentTarget=o[0],e.close(n,!0),t("#"+i).remove(),o.data("ui-tooltip-title")&&(o.attr("title")||o.attr("title",o.data("ui-tooltip-title")),o.removeData("ui-tooltip-title"))})),this.liveRegion.remove()}}),!1!==t.uiBackCompat&&t.widget("ui.tooltip",t.ui.tooltip,{options:{tooltipClass:null},_tooltip:function(){var t=this._superApply(arguments);return this.options.tooltipClass&&t.tooltip.addClass(this.options.tooltipClass),t}});t.ui.tooltip})),function(t){"function"==typeof define&&define.amd?define(["jquery"],t):t("object"==typeof exports?require("jquery"):jQuery)}((function(t){var e,i=navigator.userAgent,s=/iphone/i.test(i),n=/chrome/i.test(i),o=/android/i.test(i);t.mask={definitions:{9:"[0-9]",a:"[A-Za-z]","*":"[A-Za-z0-9]"},autoclear:!0,dataName:"rawMaskFn",placeholder:"_"},t.fn.extend({caret:function(t,e){var i;if(0!==this.length&&!this.is(":hidden"))return"number"==typeof t?(e="number"==typeof e?e:t,this.each((function(){this.setSelectionRange?this.setSelectionRange(t,e):this.createTextRange&&((i=this.createTextRange()).collapse(!0),i.moveEnd("character",e),i.moveStart("character",t),i.select())}))):(this[0].setSelectionRange?(t=this[0].selectionStart,e=this[0].selectionEnd):document.selection&&document.selection.createRange&&(i=document.selection.createRange(),t=0-i.duplicate().moveStart("character",-1e5),e=t+i.text.length),{begin:t,end:e})},unmask:function(){return this.trigger("unmask")},mask:function(i,a){var r,l,h,c,u,d,p;if(!i&&this.length>0){var f=t(this[0]).data(t.mask.dataName);return f?f():void 0}return a=t.extend({autoclear:t.mask.autoclear,placeholder:t.mask.placeholder,completed:null},a),r=t.mask.definitions,l=[],h=d=i.length,c=null,t.each(i.split(""),(function(t,e){"?"==e?(d--,h=t):r[e]?(l.push(new RegExp(r[e])),null===c&&(c=l.length-1),h>t&&(u=l.length-1)):l.push(null)})),this.trigger("unmask").each((function(){function f(){if(a.completed){for(var t=c;u>=t;t++)if(l[t]&&x[t]===g(t))return;a.completed.call(k)}}function g(t){return a.placeholder.charAt(t<a.placeholder.length?t:0)}function m(t){for(;++t<d&&!l[t];);return t}function _(t,e){var i,s;if(!(0>t)){for(i=t,s=m(e);d>i;i++)if(l[i]){if(!(d>s&&l[i].test(x[s])))break;x[i]=x[s],x[s]=g(s),s=m(s)}y(),k.caret(Math.max(c,t))}}function v(){w(),k.val()!=D&&k.change()}function b(t,e){var i;for(i=t;e>i&&d>i;i++)l[i]&&(x[i]=g(i))}function y(){k.val(x.join(""))}function w(t){var e,i,s,n=k.val(),o=-1;for(e=0,s=0;d>e;e++)if(l[e]){for(x[e]=g(e);s++<n.length;)if(i=n.charAt(s-1),l[e].test(i)){x[e]=i,o=e;break}if(s>n.length){b(e+1,d);break}}else x[e]===n.charAt(s)&&s++,h>e&&(o=e);return t?y():h>o+1?a.autoclear||x.join("")===C?(k.val()&&k.val(""),b(0,d)):y():(y(),k.val(k.val().substring(0,o+1))),h?e:c}var k=t(this),x=t.map(i.split(""),(function(t,e){return"?"!=t?r[t]?g(e):t:void 0})),C=x.join(""),D=k.val();k.data(t.mask.dataName,(function(){return t.map(x,(function(t,e){return l[e]&&t!=g(e)?t:null})).join("")})),k.one("unmask",(function(){k.off(".mask").removeData(t.mask.dataName)})).on("focus.mask",(function(){var t;k.prop("readonly")||(clearTimeout(e),D=k.val(),t=w(),e=setTimeout((function(){k.get(0)===document.activeElement&&(y(),t==i.replace("?","").length?k.caret(0,t):k.caret(t))}),10))})).on("blur.mask",v).on("keydown.mask",(function(t){if(!k.prop("readonly")){var e,i,n,o=t.which||t.keyCode;p=k.val(),8===o||46===o||s&&127===o?(i=(e=k.caret()).begin,(n=e.end)-i==0&&(i=46!==o?function(t){for(;--t>=0&&!l[t];);return t}(i):n=m(i-1),n=46===o?m(n):n),b(i,n),_(i,n-1),t.preventDefault()):13===o?v.call(this,t):27===o&&(k.val(D),k.caret(0,w()),t.preventDefault())}})).on("keypress.mask",(function(e){if(!k.prop("readonly")){var i,s,n,a=e.which||e.keyCode,r=k.caret();if(!(e.ctrlKey||e.altKey||e.metaKey||32>a)&&a&&13!==a){if(r.end-r.begin!=0&&(b(r.begin,r.end),_(r.begin,r.end-1)),i=m(r.begin-1),d>i&&(s=String.fromCharCode(a),l[i].test(s))){if(function(t){var e,i,s,n;for(e=t,i=g(t);d>e;e++)if(l[e]){if(s=m(e),n=x[e],x[e]=i,!(d>s&&l[s].test(n)))break;i=n}}(i),x[i]=s,y(),n=m(i),o){setTimeout((function(){t.proxy(t.fn.caret,k,n)()}),0)}else k.caret(n);r.begin<=u&&f()}e.preventDefault()}}})).on("input.mask paste.mask",(function(){k.prop("readonly")||setTimeout((function(){var t=w(!0);k.caret(t),f()}),0)})),n&&o&&k.off("input.mask").on("input.mask",(function(){var t=k.val(),e=k.caret();if(p&&p.length&&p.length>t.length){for(w(!0);e.begin>0&&!l[e.begin-1];)e.begin--;if(0===e.begin)for(;e.begin<c&&!l[e.begin];)e.begin++;k.caret(e.begin,e.begin)}else{for(w(!0);e.begin<d&&!l[e.begin];)e.begin++;k.caret(e.begin,e.begin)}f()})),w()}))}})})),window.isMobile=function(){return window.matchMedia("(max-width: 767px)").matches},window.isTablet=function(){return window.matchMedia("(max-width: 1023px)").matches},window.isDesktop=function(){return window.matchMedia("(min-width: 1024px)").matches},window.isMobileSafari=()=>{const t=window.navigator.userAgent,e=!!t.match(/iP(ad|od|hone)/i),i=!!t.match(/WebKit/i);return e&&i&&!t.match(/CriOS/i)&&!t.match(/OPiOS/i)},(()=>{const t=document.querySelector(".welcome");t&&t.querySelectorAll(".contract__item").length>1&&(t.classList.add("old"),window.isMobile()&&$((function(){$("#accordion").accordion({heightStyle:"content",collapsible:!0})})))})(),(()=>{const t=document.querySelector(".passport-form"),e=document.querySelector(".passport-form button");t&&e.addEventListener("click",(function(){t.classList.add("submitted")}))})(),$((function(){$("#number").mask("9999 999999",{placeholder:" "}),$("#code").mask("999-999",{placeholder:" "}),$("#postcode").mask("999999",{placeholder:" "}),$("#issuedate").mask("99/99/9999",{placeholder:"01/01/2001"}),$("#birthday").mask("99/99/9999",{placeholder:"01/01/1990"})}));